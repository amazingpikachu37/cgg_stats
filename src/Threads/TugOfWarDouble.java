...
public class TugOfWarDouble extends Statable {
    public TugOfWarDouble() {
        super("tug_of_war_double", List.of("tug_of_war_double"),"America/Montreal");
    }
    ...
    public String[] link() {
        return new String[]{"https://counting.gg/thread/tug_of_war_double"};
    }
