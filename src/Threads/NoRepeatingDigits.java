...
public class NoRepeatingDigits extends Statable {
    public NoRepeatingDigits() {
        super("no_repeating_digits", List.of("no_repeating_digits"),"America/Montreal");
    }
    ...
    public String[] link() {
        return new String[]{"https://counting.gg/thread/no_repeating_digits"};
    }
