...
public class WaveDouble extends DoubleCountingThread {
    public WaveDouble() {
        super("wave_double", List.of("wave_double"),"America/Montreal");
    }
    ...
    public String[] link() {
        return new String[]{"https://counting.gg/thread/wave_double"};
    }
