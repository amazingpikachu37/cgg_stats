...
public class DatesDouble extends DoubleCountingThread {
    public DatesDouble() {
        super("dates_double", List.of("dates_double"),"America/Montreal");
    }
    ...
    public String[] link() {
        return new String[]{"https://counting.gg/thread/dates_double"};
    }
