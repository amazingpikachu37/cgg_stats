...
public class NoMistakes extends NoMistakesThread {
    public NoMistakes() {
        super("no_mistakes", List.of("no_mistakes"), "America/Montreal");
    }
    ...
    public String[] link() {
        return new String[]{"https://counting.gg/thread/no_mistakes"};
    }
