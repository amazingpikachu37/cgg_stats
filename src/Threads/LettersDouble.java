...
public class LettersDouble extends DoubleCountingThread {
    public LettersDouble() {
        super("letters_double", List.of("letters_double"), "America/Montreal");
    }
    ...
    public String[] link() {
        return new String[]{"https://counting.gg/thread/letters_double"};
    }
