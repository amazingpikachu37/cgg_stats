...
public class Permutations extends Statable {
    public Permutations() {
        super("permutations", List.of("permutations"),"America/Montreal");
    }
    ...
    public String[] link() {
        return new String[]{"https://counting.gg/thread/permutations"};
    }
