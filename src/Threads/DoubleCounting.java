...
public class DoubleCounting extends DoubleCountingThread {
    public DoubleCounting() {
        super("double_counting", List.of("double_counting"), "America/Montreal");
    }
    ...
    public String[] link() {
        return new String[]{"https://counting.gg/thread/double_counting"};
    }
